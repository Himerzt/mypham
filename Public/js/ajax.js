...
$(document).ready(function () {
  ...
  $(".Order").click(function () {
    ...
    title = "<p><i class='fa-solid fa-circle-exclamation'></i> Cảm ơn bạn đã mua hàng tại Nuty Cosmetics. Bạn vui lòng chờ xác nhận đơn hàng qua email từ nhân viên Inbox/Order sau khi kiểm tra tình trạng còn hàng tại kho. Vui lòng <b>KHÔNG</b> chuyển khoản trước khi nhận được xác nhận từ Nuty. Xin cảm ơn!</p>";
    inforBank = "<p>Sau khi nhân viên Inbox/Order xác nhận còn hàng, Bạn vui lòng chuyển khoản với nội dung (copy đúng nội dung này để Nuty kiểm tra nhanh cho bạn): <b>#255118 124124 xxxx xxxx</b>vào tài khoản ngân hàng sau:</p>" + "<div class='Infor__Bank'>" + "<b>THÔNG TIN TÀI KHOẢN NGÂN HÀNG CỦA CHÚNG TÔI</b>" + "<div class='Infor__Bank--Contain'>" + "<div>NGUYỄN THỊ THẢO NGA</div>" + "<div>Vietcombank chi nhánh: Bảy Hiền - TPHCM</div>" + "<div>Số tài khoản: <b>1016665838</b></div>" + "</div>" + "</div>";
    ...
    $.post("./Ajax/placeAnOrder", { name: name, address: address, phone: phone, email: email, noted: noted, methodPay: methodPay, total_Paypal:total_Paypal, reduce:reduce}, function (data) {
      ...
      var containPay = "<div class='tablePayed'>" + "<div class='Payed__col1'>" + "<img style='width: 250px; object-fit: cover' src='https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Superqr.svg/1200px-Superqr.svg.png' alt=''>" + "</div>" + "<div class='Payed__col2'>" + "<div class='Payed__col2--Row1'></div>" + "<div class='Payed__col2--Row2'>" + "<div class='Row2--Col Row2--Col1'>" + "<p>Mã số đơn hàng của bạn:</p>" + "<strong>" + arr[0].ID + "</strong>" + "</div>" + "<div class='Row2--Col Row2--Col2'>" + "<p>Tổng tiền thanh toán:</p>";
      if (total_Paypal > 0) {
