<footer class="Footer">
    <a href="./TrangChu" class="image-logo--footer">
        <img class="Footer__Image" src="//bizweb.dktcdn.net/100/302/551/themes/758295/assets/logo-footer.png?1699007615400" alt="">
    </a>
    <div class="Footer__Contain">
        <ul>
            <h4>Thông tin liên hệ</h4>
            <li>
                <p class=""><i class="fa-solid fa-location-dot"></i>68/10D Trần Nhân Tôn, P.2, Q.10, TP.CHM</p>
            </li>
        </ul>
        ...
        <ul>
            ...
            <li>
                ...
                <span>kawasakisga@gmail.com</span>
            </li>
            <li>
